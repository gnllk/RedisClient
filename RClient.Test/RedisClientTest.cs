...
namespace RClient.Test
{
    ...
    public class RedisClientTest
    {
        ...
        private const int ReidsDefaultTcpPort = 6379;
        ...
        public void SetTest()
        {
            ...
            {
                Assert.IsTrue(client.Set("TestName1", "TestValue1"));
                Assert.AreEqual(client.Get("TestName1"), "TestValue1");
